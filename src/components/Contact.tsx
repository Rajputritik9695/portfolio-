...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rajputritik7754@gmail.com',
    href: 'mailto:rajputritik7754@gmail.com',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/ritik-singh-rajput',
    href: 'https://linkedin.com/in/ritik-singh-rajput-49b964319',
    color: 'from-cyan-500 to-teal-500',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/Rajputritik9695',
  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p>© 2026 Ritik Singh Rajput. Crafted with passion and code.</p>
