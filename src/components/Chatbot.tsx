...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hi! I'm Hedgy 🦔. I know everything about Ritik's work and background. Ask me about his agentic workflows, LLM applications, or skills!" }
  ]);
    ...
    try {
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_API_KEY}`, {
        ...
        body: JSON.stringify({
          contents: [{
            parts: [{
              text: `You are Hedgy, a friendly and professional AI assistant for Ritik Singh Rajput's portfolio. 
              You represent Ritik, an AI ENGINEER, AI AUTOMATION ENGINEER, and AGENTIC AI DEVELOPER.
              
              Context about Ritik Singh Rajput:
              - Personal Background: AI/ML Developer passionate about building production-ready LLM applications, RAG systems, and intelligent automation workflows.
              - Education: B.Tech Computer Science & Engineering (AI) at IIMT College of Engineering (Expected 2027).
              - Experience: Applied AI Intern at 1M1B Green Skill.
              - Technical Skills: Python, SQL, LLMs, Prompt Engineering, RAG, Agentic AI, Embeddings, Semantic Search, LangChain, n8n, Gemini API, Groq API, Pandas, NumPy.
              - Major Projects: 
                - AI Hospital Appointment System: Automated scheduling with agentic AI workflows.
                - Stubble Burning Agent: AI-driven agricultural monitoring and predictive alerting.
                - AI Recruitment Automation: Multi-criteria evaluation using Gemini LLM and n8n.
                - Local RAG PDF Assistant: Context-aware Q&A on PDF documents with <100ms latency.
              
              Tone: Professional, warm, and data-driven. Highlight his technical precision and passion for AI. Keep answers highly concise (under 3 sentences) unless asked for more detail.
          ...
          >
            ...
            <div className="p-4 flex justify-between items-center" style={{ background: '#1c1c24' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-md">Hedgy (Ritik's AI)</h3>
